...
simplerandomforest <- function(
  ...
  result <- simplerandomforestCpp(x, y.numeric, num.trees, mtry, replace, sample.fraction, num.threads)
  ...
  result$importance = stats::setNames(as.vector(result$importance), dimnames(x)[[2]])
